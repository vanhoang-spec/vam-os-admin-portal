/** Client-safe, approved mentor intake content shared by application and renewal. */
export const MENTOR_UNIVERSITY_OPTIONS = Object.freeze([
...
export const MENTOR_SUPPORT_CONTACTS = Object.freeze([
  {
    name: "Như Liễu",
    role: "Đồng Chủ tịch UEH Mentoring",
    email: "lieu.nguyen@hoatay.com.vn"
  },
  {
    name: "Quốc Vĩ",
    role: "Coreteam UEH Mentoring",
    phone: "0905.376.392",
    email: "luongquocvihcm12@gmail.com"
  },
  {
    name: "Khánh Vy",
