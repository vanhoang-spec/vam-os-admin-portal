...
const { holder, mockTables, mockErrors, mockFrom, mockSupabaseState } = vi.hoisted(() => {
  ...
  return { holder, mockTables: tables, mockErrors: errors, mockFrom: fromFn, mockSupabaseState: supabaseState };
});
