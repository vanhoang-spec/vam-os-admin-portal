-- VAM OS — MIGRATION 059 OWNER PRE-APPLY PREFLIGHT — EXECUTION PACKET
-- packet: VAM059_OWNER_PREFLIGHT_EXEC_V1
--
...
-- previously prepared session. Run this BEFORE migration 059 is applied.
--
-- ------------------------------------------------------------
...
--   docs/audits/sql/design_only/VAM_OS_MIGRATION_059_PREFLIGHT.sql
...
-- Pass criteria: overall_status = PASS, eligible = true, failureCount = 0, failed_assertions = []
--
