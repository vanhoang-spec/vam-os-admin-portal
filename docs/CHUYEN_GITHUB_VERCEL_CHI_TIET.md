...
**Gián đoạn dịch vụ:** chỉ một lần, khoảng 2–5 phút, ở bước chuyển tên miền. Mọi
bước khác không ảnh hưởng người dùng.
...
| 5. Kiểm tra | **Anh Hoàng** |
| 6. Chuyển tên miền | **Anh Hoàng**, rồi anh Thắng |
| 7. Dọn dẹp | Cả hai |
...
- **Chỉ có `...vercel.app`** → không có tên miền riêng. **Bỏ qua được Bước 6** — nhẹ hơn nhiều.
...
2. Lần đầu Vercel sẽ hỏi quyền đọc GitHub → bấm **Install** / **Configure**, chọn
   **All repositories** hoặc chỉ chọn `vam-os-admin-portal`
3. Tìm `vam-os-admin-portal` trong danh sách → bấm **Import**
...
4. **Kiểm tra `VAM_OS_PUBLIC_BASE_URL`** — biến này quyết định đường link trong email
   gửi đi. Tạm để nguyên giá trị cũ, Bước 6 sẽ sửa.
...
## 6.1 Sửa lại đường link trong email
